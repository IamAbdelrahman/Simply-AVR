...
/*   PORT            PIN					STATE			*/
    {PORTA,         Pin0,               DIO_OUTPUT},
    {PORTA,         Pin1,               DIO_OUTPUT},
    {PORTA,         Pin2,               DIO_OUTPUT},
    {PORTA,         Pin3,               DIO_OUTPUT},
    {PORTA,         Pin4,               DIO_OUTPUT},
    {PORTA,         Pin5,               DIO_OUTPUT},
    {PORTA,         Pin6,               DIO_OUTPUT},
    {PORTA,         Pin7,               DIO_OUTPUT},
    {PORTB,         Pin0,               DIO_OUTPUT},
    {PORTB,         Pin1,               DIO_OUTPUT},
    {PORTB,         Pin2,               DIO_OUTPUT},
    {PORTB,         Pin3,               DIO_OUTPUT},
    {PORTB,         Pin4,               DIO_OUTPUT},
    {PORTB,         Pin5,               DIO_OUTPUT},
    {PORTB,         Pin6,               DIO_OUTPUT},
    {PORTB,         Pin7,               DIO_OUTPUT},
};
